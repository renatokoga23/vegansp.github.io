...
/*
  GitHub Pages:
  https://renatokoga23.github.io/vegansp.github.io/
*/
const BASE_PATH = "/vegansp.github.io";

async function loadPlaces() {
  try {

    const response = await fetch(
      `${BASE_PATH}/data/places.json`
    );
    ...
    grid.innerHTML = `
      <div class="col-12">
        <div class="alert alert-danger rounded-4">
          Erro ao carregar data/places.json.
          <br><br>
          BASE_PATH atual:
    ...
    <div class="col-md-6 col-lg-4">
      ...
      <article class="card place-card h-100 shadow-sm">
        ...
        <div class="card-body p-4">
          ...
          <a
            href="${BASE_PATH}/${place.categorySlug}/${place.slug}/"
